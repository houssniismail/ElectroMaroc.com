...
<div class="homedes border mt-10 ml-12 py-12 mr-12 flex justify-evenly items-center">
     <img class="imghome" src="./views/style/fleurs_violettes.jpg" alt="test">
...
<div class="homedes border mt-10 ml-12 py-12 mr-12 flex snap-center top-12 relative justify-evenly items-center">
  ...
  <img class="imghome" src="./views/style/fleurs_violettes.jpg" alt="htdtd">
</div>
<div class="homedes border mt-10 ml-12 py-12 mr-12  flex snap-center top-12 relative justify-evenly items-center">
  <img class="imghome" src="./views/style/fleurs_violettes.jpg" alt="">
  <div class="text-center">
   <h1 class="  text-center">ELECTRO<span class=" text-red-700">MAROC</span></h1>
  <br>
  <h2>A website for selling electronic devices of high quality. We welcome all visitors</h2>
