...
<div class="product max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 text-center mx-auto mt-16">
    <a href="#">
        <img class="img rounded-t-lg mr-auto ml-auto m-4" src="<?php echo $elements['image'];?>" alt="" />
    </a>
    <strong><?php echo $elements['name'];?></strong>
    <h2><?php echo $elements['prix_achat'] . " . 00 $";?></h2>
    <div class="p-5">
      <form action="" method="POST">
        <input type="text" name="id_client" value="<?php echo $_SESSION['Id'];?>">
        <input type="" name="id" value="<?php echo $elements['id'];?>">
        <input name="image" type="text" value="<?php echo $elements['image'];?>">
        <input type="" name="name" value="<?php echo $elements['name'];?>">
        <input name="quentite" type="number" >
        <input type="date" class="date_de_creation" name="date_creation">
      <button name="add_to_cart" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            add to cart
        </button>
      </form>
    </div>
...
<script>
  var i=0;
  for(i=0; i<document.querySelector(".date_de_creation").length; i++){
    document.querySelector(".date_de_creation").valueAsDate = new Date();
  }
console.log(querySelector(".date_de_creation").length);
</script>
</body>
</html>